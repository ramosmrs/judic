...
class ElementosPagina {
	...
	public static $cabecalhoTela = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
			...
			<title>Controle de Processos - SIGRH/RJ</title>
			...
			<div class='principal_head'>
				<div id='header'>
					<div id='topo'> 
						<div id='logoportal' title='Portal do Governo do Estado do Rio de Janeiro'><a href='http://www.rj.gov.br/' target='_blank'>Portal do Governo do Estado do Rio de Janeiro</a>
						</div>
						<div id='topo_menu'>
								<ul>
		...
		<table border='0' width='968' bgcolor='#FFFFFF' align='center' cellpadding='0' cellspacing='0' >
			<td bgcolor='#FFFFFF'>
			   ...
			   <ul id= 'menuhor'>
					...
					<li> <a href= 'DemandaControleFiltro.php' title= 'Demandas por usu�rio'>Demandas por usu�rio</a> </li>
					...
					<li> <a href= '../index.php?class=UsuarioControle' title= 'Usu�rios'>Usu�rios</a> </li>
					...
					<li> <a href= '../index.php?class=SituacaoControle' title= 'Situa��o'>Situa��o</a> </li>
				</ul>
				</div> 
	...
	public static $menuTela2 = "
		...
		<td bgcolor='#FFFFFF'>
		   ...
		   <ul id= 'menuhor'>
				...
				<li> <a href= 'Controle/DemandaControleFiltro.php' title= 'Demandas por usu�rio'>Demandas por usu�rio</a> </li>
				<li> <a href= 'index.php?class=UsuarioControle' title= 'Usu�rios'>Usu�rios</a> </li>
				<li> <a href= 'index.php?class=TipoDemandaControle' title= 'Tipos de demanda'>Tipos de demanda</a> </li>
				<li> <a href= 'index.php?class=PrioridadeControle' title= 'Prioridades'>Prioridades</a> </li>
				<li> <a href= 'index.php?class=SituacaoControle' title= 'Situa��o'>Situa��o</a> </li>
	...
	public static $rodapeTela = " 
			...
			<div id='bg_footer'>
				<div title='Esta obra é licenciada sob uma licença Creative Commons Atribuio 2.0 Brasil' id='copyright'>
				</div>
	...
	public static $Indisponivel = "
			...
			<tr>
				<td align='left' >
		        <p align='left' class='tit_conteudo'>SIGRH-RJ: Controle de Processos</p>
		        <br>
		        <br>
